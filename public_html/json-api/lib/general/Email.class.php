...
';
	...
	public function sendWelcomeEmail($receiverFirstName, $receiverEmail, $confirmationCode, $amount)
	{
							...
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td class="content-block">
										Thank you ' . $receiverFirstName . ' for becoming a March Tennis Club Member.  We are looking forward to a great tennis season.  Please make a cheque payable to <strong>"March Tennis Club"</strong> for the amount of <strong>'.$amount.'</strong> to complete your registration process.
									</td>
								</tr>
								...
								<tr>
									<td class="content-block">
										<a href="http://marchtennisclub.com/confirmemail.php?email='.$receiverEmail.'&confirmation_code='.$confirmationCode.'" class="btn-primary">Confirm email address</a>
									</td>
								</tr>
								<tr>
									<td class="content-block">
